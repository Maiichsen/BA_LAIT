...
<template>
	<div class="bg-white rounded border border-tutara-200">
		<div class="shadow py-1 px-2">TOOLBAR</div>
		<textarea class="w-full h-full m-0 outline-none p-2 cursor-text pb-50 h-auto resize-none" v-model="editableText" />
	</div>
</template>
