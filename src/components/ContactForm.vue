...
<template>
  <form @submit.prevent="handleSubmit" class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="flex flex-col relative gap-1">
      <label class="text-tutara-900 text-t3" for="contact-name">
        Navn *
      </label>
      <input
        id="contact-name"
    ...
    <!-- Telefonnummer (Phone) -->
    <div class="flex flex-col relative gap-1">
      <label class="text-tutara-900 text-t3" for="contact-phone">
        Telefonnummer *
      </label>
      <input
        id="contact-phone"
    ...
    <!-- Virksomhed (Company) -->
    <div class="flex flex-col relative gap-1">
      <label class="text-tutara-900 text-t3" for="contact-company">
        Virksomhed
      </label>
      <input
        id="contact-company"
    ...
    <!-- E-mail -->
    <div class="flex flex-col relative gap-1">
      <label class="text-tutara-900 text-t3" for="contact-email">
        E-mail
      </label>
      <input
        id="contact-email"
    ...
    <div class="flex flex-col col-span-full relative gap-1">
      <label class="text-tutara-900 text-t3" for="contact-message">
        Besked
      </label>
      <textarea
        id="contact-message"
    ...
    <div class="col-span-full text-tutara-900 text-p1">
      <p>
        Ved at indsende denne formular, accepterer du LAITs privatpolitik
      </p>
    </div>
