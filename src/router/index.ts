...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      ...
      props: true,
      component: () => import('@/views/courseViews/CourseEditorView.vue'),
      children: [
        {
          path: '',
          name: 'frontpage',
          props: true,
          component: () => import('@/views/courseViews/CourseDetailsView.vue'),
        },
        {
          path: ':page_id',
          name: 'courseContent',
          props: true,
          component: () => import('@/views/courseViews/CreateContentView.vue'),
        },
      ],
    },
    {
