...
<template>
  <form @submit.prevent="handleUpdateUser">
    ...
    <BaseInput input-type="text" placeholder="firstname" input-id="firstname"
               label-text="new first name" layout="stacked" v-model="userFirstName" />
    <BaseInput input-type="text" placeholder="lastname" input-id="lastname"
               label-text="new last name" layout="stacked" v-model="userLastName"/>
    <br>
